#ifndef SXS_BLOCK_POLICY_WASM_CORE_H
#define SXS_BLOCK_POLICY_WASM_CORE_H
...
#define BLOCK_EXTRA_ACTION(context) SXS_WASM_ACTION_ERROR
#endif
#ifndef BLOCK_PREPARE_APPEND
#define BLOCK_PREPARE_APPEND(context, lpn, old_ppa, request, oob, oob_length) 0
#endif
                                 ...
                                 sxs_u64 *ppa_out, sxs_u64 *latency_out)
{
    ...
    (void)lpn;
    (void)old_ppa;
    if (BLOCK_PREPARE_APPEND(context, lpn, old_ppa, &request, oob,
                             &oob_length) != 0 ||
...
#endif /* SXS_BLOCK_POLICY_WASM_CORE_H */
