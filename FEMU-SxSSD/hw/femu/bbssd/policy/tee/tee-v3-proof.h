...
#define TEE_V3_SCOPED_ERROR_CAPACITY 65U
...
struct tee_v3_pending_controller { struct tee_v2_write_context *write;uint64_t current_op;uint64_t last_touch_op;uint64_t timeout_ops;int32_t last_error_code;uint32_t failed_segment_index;bool has_error;bool error_precedes_passive;bool reject_active_supersession;bool error_identity_valid;uint8_t error_file_id;uint32_t error_chunk_id;struct tee_v3_scoped_error scoped_errors[TEE_V3_SCOPED_ERROR_CAPACITY]; };
